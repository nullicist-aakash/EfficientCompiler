...
static consteval auto get_parser()
{
    ...
    using PI = ProductionInfo<NonTerminal, Terminal>;

    constexpr auto productions = []()
        {
            return array
            {
...
int main()
{
    ...
    ProductionInfo<NonTerminal, Terminal> prod{ NonTerminal::start, {NonTerminal::start, Terminal::IDENTIFIER} };
